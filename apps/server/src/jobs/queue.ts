...
export const competitionDispatchQueue = new Queue("competition-dispatch", { connection })
export const venueRotationDispatchQueue = new Queue("venue-rotation-dispatch", { connection })