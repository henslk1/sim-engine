      ...
      <div className="p-4 space-y-3 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-[300px_1fr] gap-2 items-start">
          <section className="rounded-lg border border-border bg-card shadow-sm">
            ...
            <div className="p-3 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="flex flex-col gap-1">
                  <label className="text-[10px] font-medium uppercase tracking-wide text-muted-foreground">Mood Effect <span className="font-normal">(optional)</span></label>
                  <Input
                    className="h-8 text-sm"
                    type="number"
                    step="0.01"
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-[10px] font-medium uppercase tracking-wide text-muted-foreground">Energy Effect <span className="font-normal">(optional)</span></label>
                  <Input
                    className="h-8 text-sm"
                    type="number"
                    step="0.01"
              ...
              <div className="flex flex-col gap-1">
                <label className="text-[10px] font-medium uppercase tracking-wide text-muted-foreground">Onset Min Cycle <span className="font-normal">(optional)</span></label>
                <Input
                  className="h-8 text-sm"
                  type="number"
                  step="1"
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="flex flex-col gap-1">
                  <label className="text-[10px] font-medium uppercase tracking-wide text-muted-foreground">Fatality Chance <span className="font-normal">(0–1)</span></label>
                  <Input
                    className="h-8 text-sm"
                    type="number"
                    step="0.01"
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-[10px] font-medium uppercase tracking-wide text-muted-foreground">Fatal Max Cycle <span className="font-normal">(optional)</span></label>
                  <Input
                    className="h-8 text-sm"
                    type="number"
                    step="1"
          ...
          {editing.id && (
            <section className="rounded-lg border border-border bg-card shadow-sm">
              <div className="border-b border-border bg-secondary/40 px-3 py-2">
                <h2 className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Behaviors & Symptoms</h2>
              </div>
